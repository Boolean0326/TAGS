...
"""
GITHUB - https://github.com/Cedrick0326/TAGS
"""
        ...
        try:
            ...
            if choice == 1:
                ...
                if users_login[username] == password:
                    del users_login[username]
                    print(Fore.GREEN + f"\nAccount of Teacher '{username}' has been removed." + Style.RESET_ALL)
                else:
                ...
                while True:
                    ...
                    if choice == '1':
                        ...
                        #Restoring saved User and password from csv
        ...
        try:           
            ...
            if choice == 1:
                ...
                if student_delete in students:
                    ...
                    print(Fore.LIGHTGREEN_EX + f'Student No. {student_delete} Removed from the list' + Style.RESET_ALL)
                else:
                ...
                if choice == '1':
                    ...
                    with open(csv_file, 'w', newline='') as Teacher_file: #new line para walang spacing
                        ...
                        for Student_num, info in students.items(): # Write student data
                            for subject, grade in info['subjects'].items():
                                #i used :.1f to round off the decimal
                                writer.writerow([Student_num,info["name"], subject, grade, f"{info['average']:.1f}", info['letter_grade']])
...
def Search_student():
    ...
    student_num = input("\nEnter the Student No. to view grades: ")
    found = False
    csv_file = 'Teacher.csv'
    ...
    with open(csv_file, 'r') as file:
        ...
        print(f"\nGrades for Student No. {student_num}:")
        ...
        for row in reader:
            ...
            if student_no == student_num:
                print(f"Name: {name} Subject: {subject}, Grade: {grade}, Average: {average}, Final Grade: {final_grade}")
                found = True  

    if not found:
        print(f"No records found for student: {student_num}")
